...
export default function Home() {
  ...
  const [viewLevel, setViewLevel] = useState<'campaign' | 'adset' | 'creative' | 'concept' | 'persona'>('campaign')
        ...
        <div className="ml-52 p-8">
          ...
          {activeTab === 'performance' && (
            <div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                      ...
                      {viewLevel === 'persona' && 'Performance by Persona'}
                    </h2>
                    <p className={`mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      ...
                      {viewLevel === 'persona' && 'Analyze weekly performance trends across personas'}
                    </p>
                  </div>
              ...
              {viewLevel === 'persona' && <CreativePersonaReportView isDark={isDark} />}
            </div>
          )}
